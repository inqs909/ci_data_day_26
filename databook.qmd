...
format:
  html:
    ...
    margin-header: |
      ![](/img/SCCDS.png)
      ![](/img/csuci_ds2.png)
      ![](/img/MathLogo(Updated).png)
---


1. `Island` 
    - The Island that the animal was captured in.
...
4.  `TrapDate`
    - Date trap was investigated.
5.  `NightNumber`
    - Night the trap was investigated.
6.  `TrapNumber`
    - Trap number.
7. `TrapResult`
    - Result of the Trap
...
10. `AgeClass`
    ...
    - 1, 2, 3, 4 - successive values given to record amount of tooth wear on molar, from 0 (none) to 4 (the most), categorical data
11. `Weight`
    - The weight of the captured animal.
12. `Weight units`
    - The units of the weight of the captured animal.
13. `BodyCondition`
    - The condition of the animals body.

14. `ReproductiveStatus`
